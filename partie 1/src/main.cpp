...
static void afficherAide() {
    ...
    std::cout << "  mode prev|eclair      -> Changer le mode de paiement\n";
    std::cout << "  pay                   -> Finaliser paiement (etat Terminee requis)\n";
    std::cout << "  pay prev|eclair       -> Alias mode + payer\n";
    ...
    while (true) {
        ...
        if (cmd == "q") {
            ...
            if (arg == "prev") {
                ...
                commande.changerMode(ModePaiement::Prevente);
            }
            else if (arg == "eclair") {

                commande.changerMode(ModePaiement::Eclair);
            }
            else {
                std::cout << "Commande inconnue.\n";
            }
            ...
            if (arg.empty()) {
                ...
                commande.payerAvecMode(ModePaiement::Prevente);
            }
            else if (arg == "eclair") {
                commande.payerAvecMode(ModePaiement::Eclair);
            }
            else {
                std::cout << "Commande inconnue.\n";
            }
